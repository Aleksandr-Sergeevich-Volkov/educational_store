...
class TestRoutes(TestCase):
    def setUp(self):
        ...
        self.size = Size.objects.create(name="4", brand_size_id=self.brend.id)
        self.model_type = Model_type.objects.create(name="Стандартная", brand_size_id=self.brend.id)
